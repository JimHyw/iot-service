...
/*****************************电视墙 end******************************/
    ...
    public static final int COMM_ALARM_DEFOCUS = 0x1151;
    /*************
     * 操作异常类型(消息方式, 回调方式(保留))
     ****************/
...
//智能设备类型
    ...
    public static class NET_DVR_PDC_QUERY_COND extends HIKSDKStructure {
    	public int dwSize;
    	public int dwChannel;
    	public NET_DVR_TIME_EX struStartTime = new NET_DVR_TIME_EX();	// 查询开始时间 
    	public NET_DVR_TIME_EX struEndTime = new NET_DVR_TIME_EX();		// 查询结束时间 
    	public byte byReportType;	// 查询类型：0- 无效值，1- 日报表，2- 周报表，3- 月报表，4- 年报表 
    	public byte byEnableProgramStatistics;	//是否按节目统计：0- 否，1- 是 
    	public byte byTriggerPeopleCountingData;	//触发客流统计数据查询使能(开启之后只查询信号量触发的客流量数据)：0- 否，1- 是 
    	public byte byRes1;
    	public int dwPlayScheduleNo;
    	public byte[] byRes = new byte[120];
    }
    
    
    public static class NET_DVR_PDC_RESULT extends HIKSDKStructure {
    	public int dwSize;
    	public NET_DVR_TIME_EX struStartTime;	// 查询开始时间 
    	public NET_DVR_TIME_EX struEndTime;		// 查询结束时间 
    	public int dwEnterNum;	// 进入人数 
    	public int dwLeaveNum;	// 离开人数
    	public NET_DVR_PROGRAM_INFO struProgramInfo;	// 节目信息
    	public int dwPeoplePassing;
...
14-白炽灯 (IncandescentLamp)，15-暖光灯(Warm Light Lamp)，16-自然光(Natural Light) */
    ...
    public static class NET_DVR_DEFOCUS_ALARM extends HIKSDKStructure {
    	public int dwSize;
    	public NET_VCA_DEV_INFO struDevInfo;
    	public short vDevInfoIvmsChannelEx;
    	public byte[] byRes1 = new byte[2];
    	public short dwRelativeTime;
    	public short dwAbsTime;
    ...
    public static class NET_DEV_ALARMINFO_V30 extends HIKSDKStructure {
    	public int dwAlarmType;
